...
local button_bg = beautiful.nord1
...
local create_button = function(symbol, hover_color, text, command)
    local icon = wibox.widget({
        ...
        valign = "center",
        font = icon_font,
        markup = helpers.ui.colorize_text(symbol, beautiful.nord3),
    ...
    button:connect_signal("mouse::leave", function()
        icon.markup = helpers.ui.colorize_text(icon.text, beautiful.nord3)
        button.border_color = beautiful.nord3
    end)
